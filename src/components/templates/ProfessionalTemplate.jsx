    ...
    switch (sectionType) {
      case 'personalInfo':
        return data.personalInfo && (
          <div key="personalInfo" className="bg-gray-800 text-white p-6 -m-6 mb-4 avoid-break">
      ...
      case 'experience':
        return data.experience && data.experience.length > 0 && (
          <div key="experience" className="mb-4 section-container">
            <h2 className="text-lg font-bold text-gray-800 bg-gray-100 px-3 py-2 mb-3 section-header">
              PROFESSIONAL EXPERIENCE
            </h2>
            {data.experience.map((exp, idx) => (
              <div key={idx} className="mb-3 px-3 resume-item">
        ...
        return data.education && data.education.length > 0 && (
          <div key="education" className="mb-4 section-container">
            ...
            {data.education.map((edu, idx) => (
              <div key={idx} className="mb-2 px-3 resume-item">
          ...
          if (section) {
            return (
              <div key={sectionType} className="mb-4 avoid-break">
                <h2 className="text-lg font-bold text-gray-800 bg-gray-100 px-3 py-2 mb-3">
