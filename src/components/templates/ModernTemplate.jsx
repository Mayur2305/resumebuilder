    ...
    switch (sectionType) {
      case 'personalInfo':
        return data.personalInfo && (
          <div key="personalInfo" className="border-b-4 border-blue-600 pb-4 mb-4 avoid-break">
      ...
      case 'experience':
        return data.experience && data.experience.length > 0 && (
          <div key="experience" className="mb-4 section-container">
            <h3 className="text-sm font-bold text-blue-600 uppercase mb-2 border-b border-gray-300 pb-1 section-header">
              Experience
            </h3>
