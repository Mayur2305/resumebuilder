    ...
    switch (sectionType) {
      case 'personalInfo':
        return data.personalInfo && (
          <div key="personalInfo" className="text-center mb-6 border-b-2 border-gray-800 pb-4 avoid-break">
      ...
      case 'experience':
        return data.experience && data.experience.length > 0 && (
          <div key="experience" className="mb-4 resume-section">
            <h2 className="text-lg font-bold text-gray-800 uppercase border-b border-gray-400 mb-2">Professional Experience</h2>
      ...
      case 'education':
        return data.education && data.education.length > 0 && (
          <div key="education" className="mb-4 resume-section">
            <h2 className="text-lg font-bold text-gray-800 uppercase border-b border-gray-400 mb-2">Education</h2>
      ...
      case 'skills':
        return data.skills && data.skills.length > 0 && (
          <div key="skills" className="mb-4 resume-section avoid-break">
      ...
      case 'projects':
        return data.projects && data.projects.length > 0 && (
          <div key="projects" className="mb-4 resume-section">
            <h2 className="text-lg font-bold text-gray-800 uppercase border-b border-gray-400 mb-2">Projects</h2>
      ...
      default:
        if (sectionType.startsWith('custom-')) {
          ...
          if (section) {
            return (
              <div key={sectionType} className="mb-4 resume-section">
