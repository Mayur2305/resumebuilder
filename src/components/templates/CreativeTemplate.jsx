...
const CreativeTemplate = ({ data, sections, sectionOrder = [] }) => {
    ...
    switch (sectionType) {
      case 'personalInfo':
        return data.personalInfo && (
          <div key="personalInfo" className="bg-white rounded-lg p-6 shadow-md mb-4 avoid-break">
      ...
      case 'experience':
        return data.experience && data.experience.length > 0 && (
          <div key="experience" className="bg-white rounded-lg p-4 shadow-md mb-4 section-container">
            <h2 className="text-lg font-bold text-purple-600 mb-3 section-header">Experience</h2>
            {data.experience.map((exp, idx) => (
              <div key={idx} className="mb-3 pb-3 border-b border-gray-200 last:border-0 resume-item">
      ...
      case 'education':
        return data.education && data.education.length > 0 && (
          <div key="education" className="bg-white rounded-lg p-4 shadow-md mb-4 section-container">
            <h2 className="text-lg font-bold text-purple-600 mb-3 section-header">Education</h2>
      ...
      case 'skills':
        return data.skills && data.skills.length > 0 && (
          <div key="skills" className="bg-white rounded-lg p-4 shadow-md mb-4 avoid-break">
      ...
      case 'projects':
        return data.projects && data.projects.length > 0 && (
          <div key="projects" className="bg-white rounded-lg p-4 shadow-md mb-4 section-container">
            <h2 className="text-lg font-bold text-purple-600 mb-3 section-header">Projects</h2>
      ...
      default:
        if (sectionType.startsWith('custom-')) {
          ...
          if (section) {
            return (
              <div key={sectionType} className="bg-white rounded-lg p-4 shadow-md mb-4 avoid-break">
  ...
  return (
    <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 -m-6">
